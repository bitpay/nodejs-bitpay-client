...
describe('BitPayResponse', function () {
  it('should handle multiple errors', async () => {
    ...
    try {
      await bitPayResponseParser.getJsonDataFromJsonResponse({"errors":[{"error":"Missing required parameter.","param":"price"},{"error":"Missing required parameter.","param":"currency"}]});
    } catch (e: any) {
