...
let requestTokens = async (option) => {
    async function requestMerchantToken(options: { headers: { "Content-type": string; "x-accept-version": string }; method: string; body: { id: string }; url: string }) {
    ...
    async function requestPayoutToken(options: { headers: { "Content-type": string; "x-accept-version": string }; method: string; body: { id: string }; url: string }) {
