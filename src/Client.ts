...
export class Client {
  ...
  constructor(
    ...
    try {
      ...
      throw new Exceptions.Generic(
        null,
        "failed to initiate client : " + e.message,
        null,
        e.apiCode
      );
    }
  ...
  private BuildConfigFromFile(filePath: string) {
    try {
      ...
      if (fs.existsSync(filePath)) {
        try {
          let ConfigObj = JSON.parse(fs.readFileSync(filePath))[
            "BitPayConfiguration"
          ];
      ...
      throw new Exceptions.Generic(
        null,
        "failed to process configuration : " + e.message,
        null,
        e.apiCode
      );
    }
  ...
  private BuildConfig(privateKey: string, tokens: Tokens) {
    try {
      ...
      if (!fs.existsSync(privateKey)) {
        try {
          this._ecKey = this._keyUtils.load_keypair(
            Buffer.from(privateKey).toString().trim()
          );
          keyHex = privateKey;
        } catch (e) {
          throw new Exceptions.Generic(
  ...
  private initKeys() {
    if (this._ecKey == null) {
      let keyHex: string;
      try {
        let privateKeyPath = this._configuration.envConfig[this._env][
          "PrivateKeyPath"
        ]
          .toString()
          .replace('"', "");
        if (fs.existsSync(privateKeyPath)) {
          ...
          keyHex = this._configuration.envConfig[this._env]["PrivateKey"]
            .toString()
            .replace('"', "");
          if (keyHex) {
            this._ecKey = this._keyUtils.load_keypair(
              Buffer.from(keyHex).toString().trim()
            );
          }
        }
      } catch (e) {
  ...
  private async LoadCurrencies(): Promise<[]> {
    try {
      let currenciesInfo = this._RESTcli
  ...
  private LoadAccessTokens() {
    try {
      ...
      throw new Exceptions.Generic(
        null,
        "When trying to load the tokens : " + e.message,
        null,
        e.apiCode
      );
    }
  ...
  private GetAccessToken(key: string): string {
    try {
      ...
      throw new Exceptions.Generic(
        null,
        "There is no token for the specified key : " + e.message,
        null,
        e.apiCode
      );
    }
  ...
  public async CreateInvoice(
    ...
    try {
      return await this._RESTcli
        .post("invoices", invoice, signRequest)
        .then((invoiceData) => {
  ...
  public async GetInvoice(
    ...
    try {
      return await this._RESTcli
        .get("invoices/" + invoiceId, params, signRequest)
        .then((invoiceData) => {
          return <InvoiceInterface>JSON.parse(invoiceData);
        });
    } catch (e) {
  ...
  public async GetInvoiceWebHook(invoiceId: string): Promise<Boolean> {
    ...
    try {
      ...
      throw new Exceptions.InvoiceQuery(
        "Invoice with ID: " + invoiceId + " Not Found : " + e.message,
        e.apiCode
      );
    }
    ...
    try {
      return await this._RESTcli
        .post("invoices/" + invoiceId + "/notifications", params)
        .then((invoiceData) => {
          const regex = /"/gi;
      ...
      throw new Exceptions.InvoiceQuery(
        "failed to deserialize BitPay server response (InvoiceQuery) : " +
          e.message,
        e.apiCode
      );
    }
  ...
  public async CreateRefund(
    ...
    try {
      return await this._RESTcli
        .post("invoices/" + invoice.id + "/refunds", refund)
        .then((refundData) => {
  ...
  public async GetRefund(
    ...
    try {
      return await this._RESTcli
        .get("invoices/" + invoice.id + "/refunds/" + refundId, params)
        .then((refundData) => {
  ...
  public async GetRefunds(invoice: Invoice): Promise<RefundInterface[]> {
    ...
    try {
      return await this._RESTcli
        .get("invoices/" + invoice.id + "/refunds", params)
        .then((refundData) => {
          return <RefundInterface[]>JSON.parse(refundData);
        });
    } catch (e) {
  ...
  public async CancelRefund(
    ...
    try {
      return await this._RESTcli
        .delete("invoices/" + invoice.id + "/refunds/" + refund.id, params)
        .then((refundData) => {
          const regex = /"/gi;
  ...
  public async DeliverBill(
    ...
    try {
      return await this._RESTcli
        .post("bills/" + billId + "/deliveries", params)
        .then((billData) => {
  ...
  public async SubmitPayoutRecipients(
    ...
    try {
      ...
      throw new Exceptions.PayoutRecipientCreation(
        "failed to deserialize BitPay server response (PayoutRecipients) : " +
          e.message,
        e.apiCode
      );
    }
  ...
  public async GetPayoutRecipient(
    ...
    try {
      return await this._RESTcli
        .get("recipients/" + recipientId, params)
        .then((recipientData) => {
          return <PayoutRecipientInterface>JSON.parse(recipientData);
        });
    } catch (e) {
      throw new Exceptions.PayoutRecipientQuery(
        "failed to deserialize BitPay server response (PayoutRecipient) : " +
          e.message,
        e.apiCode
      );
    }
  ...
  public async UpdatePayoutRecipient(
    ...
    try {
      return await this._RESTcli
        .update("recipients/" + recipientId, params)
        .then((recipientData) => {
          return <PayoutRecipientInterface>JSON.parse(recipientData);
        });
    } catch (e) {
  ...
  public async DeletePayoutRecipient(recipientId: string): Promise<Boolean> {
    ...
    try {
      return await this._RESTcli
        .delete("recipients/" + recipientId, params)
        .then((recipientData) => {
   ...
   */
  public async GetPayoutRecipientWebHook(
    recipientId: string
  ): Promise<Boolean> {
    const params = {
      token: this.GetAccessToken(Facade.Payout),
    ...
    try {
      return await this._RESTcli
        .post("recipients/" + recipientId + "/notifications", params)
        .then((recipientData) => {
          return <Boolean>JSON.parse(recipientData);
        });
    } catch (e) {
  ...
  public async CancelPayout(payoutId: string): Promise<Boolean> {
    ...
    try {
      return await this._RESTcli
        .delete("payouts/" + payoutId, params)
        .then((responseData) => {
          return <Boolean>JSON.parse(responseData);
        });
    } catch (e) {
      throw new Exceptions.PayoutDelete(
        "failed to deserialize BitPay server response (PayoutObject) : " +
          e.message,
        e.apiCode
      );
    }
  ...
  public async RequestPayoutNotification(payoutId: string): Promise<Boolean> {
    ...
    try {
      return await this._RESTcli
        .post("payouts/" + payoutId + "/notifications", params)
        .then((responseData) => {
          return <Boolean>JSON.parse(responseData);
        });
    } catch (e) {
   ...
   */
  public async SubmitPayoutBatch(
    batch: PayoutBatch
  ): Promise<PayoutBatchInterface> {
    ...
    try {
      return await this._RESTcli
        .post("payoutBatches", batch)
        .then((PayoutBatchData) => {
          return <PayoutBatchInterface>JSON.parse(PayoutBatchData);
        });
    } catch (e) {
      throw new Exceptions.PayoutBatchCreation(
        "failed to deserialize BitPay server response (PayoutBatch) : " +
          e.message,
        e.apiCode
      );
    }
  ...
  public async GetPayoutBatch(
    ...
    try {
      return await this._RESTcli
        .get("payoutBatches/" + payoutBatchId, params)
        .then((payoutBatchData) => {
          return <PayoutBatchInterface>JSON.parse(payoutBatchData);
        });
    } catch (e) {
      throw new Exceptions.PayoutBatchQuery(
        "failed to deserialize BitPay server response (PayoutBatch) : " +
          e.message,
        e.apiCode
      );
  ...
  public async CancelPayoutBatch(payoutBatchId: string): Promise<Boolean> {
    ...
    try {
      return await this._RESTcli
        .delete("payoutBatches/" + payoutBatchId, params)
        .then((responseData) => {
          return <Boolean>JSON.parse(responseData);
        });
    } catch (e) {
      throw new Exceptions.PayoutBatchCancellation(
        "failed to deserialize BitPay server response (PayoutBatch) : " +
          e.message,
        e.apiCode
      );
   ...
   */
  public async RequestPayoutBatchNotification(
    payoutBatchId: string
  ): Promise<Boolean> {
    const params = {
      token: this.GetAccessToken(Facade.Payout),
    ...
    try {
      return await this._RESTcli
        .post("payoutBatches/" + payoutBatchId + "/notifications", params)
        .then((responseData) => {
          return <Boolean>JSON.parse(responseData);
        });
    } catch (e) {
      throw new Exceptions.PayoutBatchNotification(
        "failed to deserialize BitPay server response (PayoutObject) : " +
          e.message,
        e.apiCode
      );
  ...
  public async GetSettlementReconciliationReport(
    ...
    try {
      return await this._RESTcli
        .get("settlements/" + settlement.id + "/reconciliationReport", params)
        .then((settlementData) => {
          return <SettlementInterface>JSON.parse(settlementData);
        });
    } catch (e) {
  ...
  public async CreateSubscription(
    ...
    try {
      ...
      throw new Exceptions.SubscriptionCreation(
        "failed to deserialize BitPay server response (Subscription) : " +
          e.message,
        e.apiCode
      );
    }
  ...
  public async GetSubscription(
    ...
    try {
      return await this._RESTcli
        .get("subscriptions/" + subscriptionId, params)
        .then((subscriptionData) => {
          return <SubscriptionInterface>JSON.parse(subscriptionData);
        });
    } catch (e) {
      throw new Exceptions.SubscriptionQuery(
        "failed to deserialize BitPay server response (Subscription) : " +
          e.message,
        e.apiCode
      );
  ...
  public async GetSubscriptions(
    ...
    try {
      ...
      throw new Exceptions.SubscriptionQuery(
        "failed to deserialize BitPay server response (Subscriptions) : " +
          e.message,
        e.apiCode
      );
    }
  ...
  public async UpdateSubscription(
    ...
    try {
      ...
      throw new Exceptions.PayoutQuery(
        "Subscription with ID: " + subscriptionId + " Not Found : " + e.message,
        e.apiCode
      );
    }
    ...
    try {
      return await this._RESTcli
        .update("subscriptions/" + subscriptionId, subscription)
        .then((subscriptionData) => {
          return <SubscriptionInterface>JSON.parse(subscriptionData);
        });
    } catch (e) {
      throw new Exceptions.SubscriptionUpdate(
        "failed to deserialize BitPay server response (Subscription) : " +
          e.message,
        e.apiCode
      );
