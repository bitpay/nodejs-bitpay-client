...
export class RefundClient {
    ...
    public async sendRefundNotification(refundId: string): Promise<Boolean> {
        ...
        try {
            ...
            throw new Exceptions.RefundGeneric("failed to deserialize BitPay server response (Refund) : " + e.message, e.apiCode);
        }
    }
    ...
    public async cancel(refundId: string): Promise<RefundInterface> {
        ...
        try {
            ...
            throw new Exceptions.RefundCancellation("failed to deserialize BitPay server response (Refund) : " + e.message, e.apiCode);
        }
    }
